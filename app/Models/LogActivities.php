...
class LogActivities extends Model
{
    ...
    public CONST TYPE_CREATE_EBOOK = "CREATE_EBOOK";
    public CONST TYPE_UPDATE_EBOOK = "UPDATE_EBOOK";
    public CONST TYPE_DELETE_EBOOK = "DELETE_EBOOK";

    public CONST TYPE_CREATE_EBOOK_PLACE = "CREATE_EBOOK_PLACE";
    public CONST TYPE_UPDATE_EBOOK_PLACE = "UPDATE_EBOOK_PLACE";
    public CONST TYPE_DELETE_EBOOK_PLACE = "DELETE_EBOOK_PLACE";
