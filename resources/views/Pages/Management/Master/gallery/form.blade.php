...
@section('content')
    ...
    <div class="container-fluid">
        <!-- Page Heading -->
        <h1 class="h3 text-gray-800 font-weight-bold m-2">Gallery Form</h1>
        ...
        @endif
        <!-- DataTales Example -->
        <a href="{{ route('gallery.index') }}" class="btn btn-primary m-2">Back</a>

        <form action="{{ route('gallery.storeOrUpdate') }}" method="POST" class="card" id="formDropzone"
            enctype="multipart/form-data" novalidate>
            @csrf
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Gallery Form</h6>
                </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input required type="text" name="title" value="{{ $gallery->title ?? '' }}"
    ...
    @push('script')
        ...
        <script>
            ...
            var myDropzone = new Dropzone('#formDropzone', {
                url: "{{ route('upload.gallery') }}", // Ensure the URL is correct
                ...
                init: function() {
                    ...
                    @if ($gallery)
                        existingImage = "{{ asset($gallery->image_url) ?? '' }}";
