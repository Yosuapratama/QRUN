            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('place.update') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input required name="title" class="form-control" value="{{ $Place->title }}" type="text" id="title"
                    ...
                    <div class="mb-3">
                        ...
                        <input required name="description" value="{{ $Place->description }}" class="form-control" type="text"
