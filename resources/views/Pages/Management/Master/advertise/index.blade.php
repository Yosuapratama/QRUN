                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right p-3 shadow">
                        ...
                        <div class="custom-control custom-checkbox mb-2">
                            ...
                            <input type="checkbox" class="custom-control-input toggle-column" id="toggle-time"
    ...
    @push('script')
        <script>
            ...
            $(document).ready(function() {
                ...
                const STORAGE_KEY =
                    'advertise_table_column_visibility';

                const table = $('#datatable').DataTable({

                    createdRow: function(row, data, dataIndex) {

                        $('td:eq(0)', row).css('min-width',
                            '220px');

                        $('td:eq(1)', row).css('min-width',
                            '180px');

                        $('td:eq(2)', row).css('min-width',
                            '220px');

                        $('td:eq(3)', row).css('min-width',
                            '180px');
                        ...
                        dataSrc: function(json) {
                            ...
                            if (place) {
                                ...
                                data = data.filter(item => {
                                    ...
                                    // karena places berupa HTML string
                                    let placesText = $('<div>')
                                        .html(item.places || '')
                                        .text()
                                        .toLowerCase();

                                    return placesText.includes(place);
                                });
                            }
                ...
                $('#filter-place').on('keyup', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                ...
                                url: "/management/master/advertise/" +
                                    id +
                                    "/delete",
