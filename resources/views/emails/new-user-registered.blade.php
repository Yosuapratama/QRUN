...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-color: #f4f7f6; /* Light background for the whole email */
        ...
        th {
            ...
            width: 35%; /* Slightly adjusted width */
            color: #555555;
            font-weight: 600;
            border-bottom: 1px solid #e0e0e0;
        }
...
<body>
    <div class="email-wrapper">
        <div class="email-header">
            <h2><span role="img" aria-label="user icon">👤</span> User Baru Terdaftar</h2>
        </div>

        <div class="email-content">
            <p>Seorang user baru baru saja mendaftar ke sistem:</p>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>{{ $user->approved_at ? '✅ Ya' : '❌ Belum' }}</td>
                </tr>
            </table>
        </div>
