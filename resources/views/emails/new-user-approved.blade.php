...
<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#f4f7fb">
    <tr>
        <td align="center" style="padding:40px 15px;">
            ...
            <!-- MAIN CONTAINER -->
            <table width="600" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="
                width:600px;
                max-width:600px;
                border-radius:16px;
            ...
            ">
                ...
                <!-- HEADER -->
                <tr>
                    <td bgcolor="#2d4373" align="center" style="padding:40px 20px;">
                ...
                <tr>
                    <td style="padding:45px 40px;">
                        ...
                        <table align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="80" height="80" align="center" bgcolor="#eafaf1" style="
                                    width:80px;
                                    height:80px;
                                    border-radius:40px;
                                    font-size:34px;
                        ...
                        <!-- INFO BOX -->
                        <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#f8fbff" style="
                ...
                <!-- FOOTER -->
                <tr>
                    <td bgcolor="#fafafa" align="center" style="
                        padding:24px;
